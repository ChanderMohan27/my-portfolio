...
const ContactInfo = ({ name, email, location }) => {
  ...
  return (
    ...
    >
      ...
      I am always open to discussing new opportunities, innovative projects, and creative collaborations. If you're interested. Let's connect to explore how we can work together to create something extraordinary!
