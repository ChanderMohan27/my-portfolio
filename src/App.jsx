...
function App() {
  ...
  const personalDetails = {
    ...
    brand:
      "Dedicated data science professional with a strong foundation in coding, data visualization, statistical analysis, and machine learning. My motivation for pursuing a career in Data Science is stems from its role in identify patterns, trends and extract meaningful insights from vast and complex datasets."
      };
